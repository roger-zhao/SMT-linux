...
#define TI_PREEMPT_LAZY 8 /* offsetof(struct thread_info, preempt_lazy_count)	@ */
#define TI_ADDR_LIMIT 12 /* offsetof(struct thread_info, addr_limit)	@ */
...
#define TI_THUMBEE_STATE 520 /* offsetof(struct thread_info, thumbee_state)	@ */
